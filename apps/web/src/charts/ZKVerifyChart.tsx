...
export function ZKVerifyChart() {
  ...
  useEffect(() => {
    void run();
    // Re-poll every 8s so the verifier stays warm and we recover from
  ...
  return (
    <div className="font-mono space-y-3">
      ...
      <div className="text-[9px] text-[color:var(--color-penumbra-dim)]">
        verifier = pure-Python Groth16 (py_ecc); proof generated by snarkjs + circom legal_path
        (4-node graph, 2-hop walk).
      </div>
    </div>
  );
}
