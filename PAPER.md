...
**Preprint** — arXiv (cs.CR primary, cs.LG cross-list).
Code: https://github.com/Vadale/penumbra-arena (MIT).
Data: https://huggingface.co/datasets/Vadale/penumbra-data (CC-BY-4.0).
Version: 2026-05-23.

> Citation (BibTeX):
> ```bibtex
> @misc{vadale2026penumbra,
>   title  = {Penumbra: A 50-Agent Privacy-Preserving Arena for Hands-On Cryptography, Multi-Agent RL, and Adversarial Pedagogy},
>   author = {Vadale},
>   year   = {2026},
>   eprint = {2606.XXXXX},
>   archivePrefix = {arXiv},
